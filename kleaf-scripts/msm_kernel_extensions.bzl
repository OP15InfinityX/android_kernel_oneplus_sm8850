...
#load("//vendor/oneplus/kernel/arch/arm64/boot/dts/vendor:qcom/platform_map.bzl", _get_custom_dtbo_img_list = "get_custom_dtbo_img_list", _get_dtb_list = "get_dtb_list", _get_dtbo_list = "get_dtbo_list")
#oplus devicetree overylay use oplus dir
load("//vendor/oneplus/kernel/arch/arm64/boot/dts/vendor:oplus/platform_map.bzl", _get_custom_dtbo_img_list = "get_custom_dtbo_img_list", _get_dtb_list = "get_dtb_list", _get_dtbo_list = "get_dtbo_list")
